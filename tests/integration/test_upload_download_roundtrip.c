...
static void test_upload_download_roundtrip_image(void) {
  char base_dir[1024];
  char manifest_path[1200];
  char output_path[1200];
  char input_path[1200];
  ...
  make_temp_dir(base_dir);
  snprintf(manifest_path, sizeof(manifest_path), "%s/manifest_img.bin",
           base_dir);
  snprintf(output_path, sizeof(output_path), "%s/out_img.bin", base_dir);
  snprintf(input_path, sizeof(input_path), "%s/sample.txt", TEST_FIXTURES_DIR);

  assert(echo_provider_localfs_create(base_dir, &provider) == ECHO_OK);

  assert(echo_upload_file_image(input_path, manifest_path, "pw", 8,
                                &provider) == ECHO_OK);
...
static void test_upload_download_roundtrip_image_lsb(void) {
  char base_dir[1024];
  char manifest_path[1200];
  char output_path[1200];
  char input_path[1200];
  ...
  make_temp_dir(base_dir);
  snprintf(manifest_path, sizeof(manifest_path), "%s/manifest_pnm.bin",
           base_dir);
  snprintf(output_path, sizeof(output_path), "%s/out_pnm.bin", base_dir);
  snprintf(input_path, sizeof(input_path), "%s/sample.txt", TEST_FIXTURES_DIR);

  assert(echo_provider_localfs_create(base_dir, &provider) == ECHO_OK);

  assert(echo_upload_file_image_lsb(input_path, manifest_path, "pw", 8,
                                    &provider) == ECHO_OK);
...
static void test_upload_download_roundtrip_image_png(void) {
  char base_dir[1024];
  char manifest_path[1200];
  char output_path[1200];
  char input_path[1200];
  ...
  make_temp_dir(base_dir);
  snprintf(manifest_path, sizeof(manifest_path), "%s/manifest_png.bin",
           base_dir);
  snprintf(output_path, sizeof(output_path), "%s/out_png.bin", base_dir);
  snprintf(input_path, sizeof(input_path), "%s/sample.txt", TEST_FIXTURES_DIR);

  assert(echo_provider_localfs_create(base_dir, &provider) == ECHO_OK);

  assert(echo_upload_file_image_png(input_path, manifest_path, "pw", 8,
                                    &provider) == ECHO_OK);
...
int main(void) {
  ...
  test_upload_download_roundtrip_image();
  test_upload_download_roundtrip_image_lsb();
  test_upload_download_roundtrip_image_png();
  return 0;
}
